...
from ...models.validate_user_totp_secret_json_body import ValidateUserTotpSecretJsonBody
...
def _get_kwargs(
    *,
    ...
    json_body: ValidateUserTotpSecretJsonBody,
) -> Dict[str, Any]:
    url = "{}/user/totp/validate".format(client.base_url)
