...
def _get_kwargs(
    *,
    ...
    order: Union[Unset, None, GetAdminsOrder] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Get admins
     ...
     Returns an array with one or more admins. For security reasons hashed passwords are omitted in the
    response

    Args:
        offset (Union[Unset, None, int]):
        limit (Union[Unset, None, int]):  Default: 100.
        order (Union[Unset, None, GetAdminsOrder]):  Example: ASC.
