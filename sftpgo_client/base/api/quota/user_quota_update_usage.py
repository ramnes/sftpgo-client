...
from ...models.user_quota_update_usage_mode import UserQuotaUpdateUsageMode
...
def _get_kwargs(
    ...
    *,
    ...
    mode: Union[Unset, None, UserQuotaUpdateUsageMode] = UNSET,
) -> Dict[str, Any]:
    url = "{}/quotas/users/{username}/usage".format(client.base_url, username=username)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        username (str):
        mode (Union[Unset, None, UserQuotaUpdateUsageMode]): Update type:
