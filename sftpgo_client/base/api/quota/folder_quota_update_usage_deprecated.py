...
from ...models.folder_quota_update_usage_deprecated_mode import (
...
def _get_kwargs(
    *,
    ...
    mode: Union[Unset, None, FolderQuotaUpdateUsageDeprecatedMode] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        mode (Union[Unset, None, FolderQuotaUpdateUsageDeprecatedMode]): Update type:
